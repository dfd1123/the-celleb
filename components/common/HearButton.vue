<template>
  <div heart-button>
    <input :id="`heart-${vid}`" class="checkbox" type="checkbox">
    <label :for="`heart-${vid}`">
...
[heart-button] { .ib; .vam;
  svg {
    cursor: pointer; overflow: visible; width: 40px;
  ...
  .checkbox:checked + label svg {
    .heart {transform: scale(.2); fill: #d261ff; animation: animateHeart .3s linear forwards .25s;}
